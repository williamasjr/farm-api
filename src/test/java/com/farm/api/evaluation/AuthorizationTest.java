package com.farm.api.evaluation;
...
import com.farm.api.evaluation.mock.MockPerson;
import com.farm.api.evaluation.mock.PersonFixtures;
import com.farm.api.evaluation.util.SimpleResultHandler;
import com.farm.api.evaluation.util.TestHelpers;
  ...
  private String createPersonAndAuthenticate(MockPerson person) throws Exception {
    ...
    String responseContent =
        mockMvc.perform(post("/auth/login")
                ...
                .content(TestHelpers.objectToJson(loginInfo)))
  ...
  private MockPerson performPersonCreation(MockPerson person) throws Exception {
    ...
    String responseContent =
        mockMvc.perform(post(url)
                .contentType(MediaType.APPLICATION_JSON)
                .content(TestHelpers.objectToJson(person)))
